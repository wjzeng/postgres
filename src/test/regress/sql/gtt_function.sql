...
alter table gtt.gtt_test_alter1 alter a type varchar;

create global temp table gtt_test_alter2 (a int primary key,b text);
alter table gtt_test_alter2 alter a type varchar;
